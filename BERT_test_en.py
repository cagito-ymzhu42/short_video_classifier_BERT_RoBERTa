...
fold_categories = ['保险', '储蓄', '其它', '创业', '基金', '房产', '数字货币', '泛财经', '税务', '美女', '股票-其他',
...
test_df_path = 'data/test_dataset_en_0607.xlsx'
predicted_path = 'results/test_dataset_bert_en_0607.xlsx'
