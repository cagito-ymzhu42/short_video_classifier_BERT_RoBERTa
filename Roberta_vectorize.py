...
# df = pd.read_excel("data/short_video_added-ch-0628.xlsx")
df = pd.read_excel("data/item_info_ch_0706.xlsx")

start_time = time.time()
with open("results/short_video_text_vector_ch_0705.txt", "w", encoding="UTF-8") as f:
